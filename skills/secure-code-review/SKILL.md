...
### 1. Security-Relevant File Discovery
...
# Find configuration with potential secrets
find . -type f \( -name "*.env*" -o -name "*config*" -o -name "*settings*" \) 2>/dev/null | head -20

# Identify API endpoints
grep -r -l "route\|router\|endpoint\|@app\.\|@api\." --include="*.py" --include="*.js" --include="*.ts" --include="*.go" . 2>/dev/null | head -20
```
